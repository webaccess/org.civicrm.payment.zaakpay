...
class org_civicrm_payment_zaakpay extends CRM_Core_Payment {
  ...
  function doTransferCheckout(&$params, $component) {
    ...
    $this->data = array(
      ...
      'buyerAddress' => Checksum::sanitizedParam($params['street_address-1']),
      'buyerCity' => Checksum::sanitizedParam($params['city-1']),
      'buyerState' => Checksum::sanitizedParam($params['state_province-1']),
      'buyerCountry' => Checksum::sanitizedParam($params['country-1']),
      'buyerPincode' => Checksum::sanitizedParam($params['postal_code-1']),
